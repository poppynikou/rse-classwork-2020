...
def iss_passes(lat, lon, n=5):
    ...
    #reminder that the status_code is given by a website
    # status_code = 200 means that the page was successfully loaded
    if iss_request.status_code != 200:
        # if the request failed for some reason return an empty array
        return []
    #requests the json file from the internet link given above
